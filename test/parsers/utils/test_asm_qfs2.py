...
class Qfs2ASMArchive(CompressedResource, AsmRunner):
    ...
    def uncompress(self, buffer: BufferedReader, input_length: int) -> bytes:
        ...
        self.define_variable('patterns_index_table_pointer', 0, 4)  # ptr to var_11C, start of some 256 bytes index table, probably patterns
...
class TestAsmQFS2Algorythm(unittest.TestCase):
    ...
    def test(self):
        parser_py = Qfs2Archive()
        parser_asm = Qfs2ASMArchive()
        file_name = '../../../games/nfs1/FRONTEND/ART/CHECK/AL2.QFS'
