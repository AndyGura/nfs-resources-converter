...
*Last time updated: 2026-08-03 22:49:41.219534+00:00*
...
| 16 + width \* height \* pixel_byteness | **mipmaps** | 0..up to end of block | Optional (if if dimensions are powers of two and has extra space with size >= sum of all mipmaps sizes): Bytes | - |
### **EacPalette** ###
#### **Size**: 16..? bytes ####
