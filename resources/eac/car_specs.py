...
class CarPerformanceSpec(CompoundBlock):
    ...
    class Fields(CompoundBlock.Fields):
        ...
        mass_rear_axle = RationalNumber(length=4, fraction_bits=16, is_signed=True,
                                        description='The meaning is theoretical. For all cars value is mass / 2')
        mass = RationalNumber(length=4, fraction_bits=16, is_signed=True, description='Car mass')
        unknowns0 = ArrayBlock(length=4, child=RationalNumber(length=4, fraction_bits=16, is_signed=True))
        ...
        unknowns1 = RationalNumber(length=4, fraction_bits=16, is_signed=True)
        ...
        unknowns2 = ArrayBlock(length=2, child=RationalNumber(length=4, fraction_bits=16, is_signed=True))
        ...
        unknowns3 = ArrayBlock(length=2, child=RationalNumber(length=4, fraction_bits=16, is_signed=True))
        ...
        unknowns4 = RationalNumber(length=4, fraction_bits=16, is_signed=True)
        transmission__gear_ratios = ArrayBlock(length=8,
                                               child=RationalNumber(length=4, fraction_bits=16, is_signed=True),
        ...
        unknowns5 = ArrayBlock(length=3, child=RationalNumber(length=4, fraction_bits=16, is_signed=True),
        ...
        transmission__upshifts = ArrayBlock(length=5, child=IntegerBlock(static_size=4),
                                            description='RPM value, when automatic gear box should upshift. 1 element '
                                                        'per drive gear')
        unknowns6 = ArrayBlock(length=4, child=RationalNumber(length=2, fraction_bits=8, is_signed=True))
        unknowns7 = ArrayBlock(length=7, child=RationalNumber(length=4, fraction_bits=16, is_signed=True))
        unknowns8 = ArrayBlock(length=2, child=RationalNumber(length=2, fraction_bits=8, is_signed=True))
        ...
        unknowns9 = ArrayBlock(length=13, child=RationalNumber(length=4, fraction_bits=16, is_signed=True))
...
class CarSimplifiedPerformanceSpec(CompoundBlock):
    ...
    class Fields(CompoundBlock.Fields):
        unknowns0 = ArrayBlock(length=3, child=RationalNumber(length=4, fraction_bits=16, is_signed=True),
        ...
        unknowns1 = ArrayBlock(length=3, child=RationalNumber(length=4, fraction_bits=16, is_signed=True))
        ...
        max_rpm = RationalNumber(length=4, fraction_bits=16, is_signed=True, description='Max engine RPM')
