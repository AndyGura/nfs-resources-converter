...
class AnyBitmapBlock(CompoundBlock):
    ...
    def _after_height_read(self, data, total_size, parent_read_data, **kwargs):
        ...
        if (parent_read_data and parent_read_data.get('shpi_directory').value == 'WRAP') or block_size == 0:
        ...
        self.instance_fields_map['bitmap'].length = data['width'].value * data['height'].value
