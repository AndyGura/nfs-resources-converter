...
class Color24BitDosBlock(IntegerBlock):
    def __init__(self, **kwargs):
        kwargs['static_size'] = 3
        kwargs['byte_order'] = "big"
    ...
    def to_raw_value(self, value, offset=0) -> bytes:
        ...
        return super().to_raw_value(red << 16 | green << 8 | blue, offset)
...
class Color24BitBlock(IntegerBlock):
    ...
    def to_raw_value(self, value, offset=0) -> bytes:
        return super().to_raw_value(value >> 8, offset)
...
class Color32BitBlock(IntegerBlock):
    ...
    def to_raw_value(self, value, offset=0) -> bytes:
        ...
        return super().to_raw_value(value, offset)
...
class Color16Bit0565Block(IntegerBlock):
    ...
    def to_raw_value(self, value, offset=0) -> bytes:
        ...
        return super().to_raw_value(red << 11 | green << 5 | blue, offset)
...
class Color16Bit1555Block(IntegerBlock):
    ...
    def to_raw_value(self, value, offset=0) -> bytes:
        ...
        blue = (value & 0xff00) >> 11
        alpha = value & 0xff >> 7
        return super().to_raw_value(alpha << 15 | red << 10 | green << 5 | blue, offset)
