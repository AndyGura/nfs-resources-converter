...
| 8..? | **children** | ? | Array of ? items with custom offset to items<br/>Item size: 8..? bytes<br/>Item type: One of types:<br/>- [OripGeometry](#oripgeometry)<br/>- [ShpiBlock](#shpiblock)<br/>- [WwwwBlock](#wwwwblock) | A part of block, where items data is located. Offsets are defined in previous block, lengths are calculated: either up to next item offset, or up to the end of block |
### **SoundBank** ###
#### **Size**: 512..? bytes ####
