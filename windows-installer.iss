...
UninstallDisplayIcon={app}\nfs-resources-converter.exe
Compression=lzma2
SolidCompression=yes
OutputDir=dist
OutputBaseFilename=nfs-resources-converter-windows-setup
...
[Files]
Source: "dist\nfs-resources-converter\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs
