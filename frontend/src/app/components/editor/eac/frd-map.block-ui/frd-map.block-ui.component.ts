...
export class Nfs3MapWorldEntity extends MapGraph3dEntity<ThreeVisualTypeDocRepo, any> {
...
export class FrdMapBlockUiComponent implements GuiComponentInterface, AfterViewInit, OnDestroy {
  ...
  map: Nfs3MapWorldEntity | null = null;
  ...
  private async loadPreview() {
    ...
    this.unloadPreview();
    this.map = new Nfs3MapWorldEntity(
      chunksGraph,
